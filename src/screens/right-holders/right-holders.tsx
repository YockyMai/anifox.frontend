...
import './right-holders.css'
import { RightHoldersMetadata } from './right-holders.metadata'

export const RightHoldersScreen = () => {
  return (
    <>
      <RightHoldersMetadata />
      <div className='right-holders'>
        ...
        <div className='right-holders__box'>
          <h3>
            ...
            Федерации в области защиты информации и авторских прав на контент.
          </h3>
        ...
        <div className='right-holders__box'>
          <h3>
            ...
            предоставляя неверную или искаженную информацию, пожалуйста
